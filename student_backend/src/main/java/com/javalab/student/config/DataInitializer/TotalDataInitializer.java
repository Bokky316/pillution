...
/**
    ...
    */
/**
     * ProductIngredientCategoryMapping 초기화 메서드
     *//*
...
/**
    ...
    private void initializeProducts() {
        // 카테고리 조회
        ProductCategory 여성건강 = productCategoryRepository.findByName("여성 건강/PMS").orElseThrow(() -> new IllegalArgumentException("Category not found: 여성 건강/PMS"));
        ProductCategory 관절뼈 = productCategoryRepository.findByName("관절/뼈").orElseThrow(() -> new IllegalArgumentException("Category not found: 관절/뼈"));
        ProductCategory 구강관리 = productCategoryRepository.findByName("구강 관리").orElseThrow(() -> new IllegalArgumentException("Category not found: 구강 관리"));
        ProductCategory 다이어트 = productCategoryRepository.findByName("다이어트").orElseThrow(() -> new IllegalArgumentException("Category not found: 다이어트"));
        ProductCategory 마음건강 = productCategoryRepository.findByName("마음 건강").orElseThrow(() -> new IllegalArgumentException("Category not found: 마음 건강"));
        ProductCategory 피부 = productCategoryRepository.findByName("피부").orElseThrow(() -> new IllegalArgumentException("Category not found: 피부"));
        ProductCategory 노화항산화 = productCategoryRepository.findByName("노화/항산화").orElseThrow(() -> new IllegalArgumentException("Category not found: 노화/항산화"));
        ProductCategory 피로활력 = productCategoryRepository.findByName("피로/활력").orElseThrow(() -> new IllegalArgumentException("Category not found: 피로/활력"));
        ProductCategory 간건강 = productCategoryRepository.findByName("간 건강").orElseThrow(() -> new IllegalArgumentException("Category not found: 간 건강"));
        ProductCategory 장건강 = productCategoryRepository.findByName("장 건강").orElseThrow(() -> new IllegalArgumentException("Category not found: 장 건강"));
        ProductCategory 위소화 = productCategoryRepository.findByName("위/소화").orElseThrow(() -> new IllegalArgumentException("Category not found: 위/소화"));
        ProductCategory 눈건강 = productCategoryRepository.findByName("눈 건강").orElseThrow(() -> new IllegalArgumentException("Category not found: 눈 건강"));
        ProductCategory 면역력 = productCategoryRepository.findByName("면역력").orElseThrow(() -> new IllegalArgumentException("Category not found: 면역력"));
        ProductCategory 빈혈 = productCategoryRepository.findByName("빈혈").orElseThrow(() -> new IllegalArgumentException("Category not found: 빈혈"));
        ProductCategory 수면 = productCategoryRepository.findByName("수면").orElseThrow(() -> new IllegalArgumentException("Category not found: 수면"));
        ProductCategory 모발두피 = productCategoryRepository.findByName("모발/두피").orElseThrow(() -> new IllegalArgumentException("Category not found: 모발/두피"));
        ProductCategory 만성질환 = productCategoryRepository.findByName("만성질환").orElseThrow(() -> new IllegalArgumentException("Category not found: 만성질환"));

        // 성분 조회
        ProductIngredient 감마리놀렌산 = productIngredientRepository.findByIngredientName("감마리놀렌산(GLA)")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 감마리놀렌산(GLA)"));

        ProductIngredient 엽산 = productIngredientRepository.findByIngredientName("엽산")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 엽산"));

        ProductIngredient 철분 = productIngredientRepository.findByIngredientName("철분")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 철분"));

        ProductIngredient 칼슘 = productIngredientRepository.findByIngredientName("칼슘")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 칼슘"));

        ProductIngredient 비타민D = productIngredientRepository.findByIngredientName("비타민D")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 비타민D"));

        ProductIngredient GABA = productIngredientRepository.findByIngredientName("GABA")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: GABA"));

        ProductIngredient 비타민B군 = productIngredientRepository.findByIngredientName("비타민B군")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 비타민B군"));

        ProductIngredient 마그네슘 = productIngredientRepository.findByIngredientName("마그네슘")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 마그네슘"));

        ProductIngredient 비타민C = productIngredientRepository.findByIngredientName("비타민C")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 비타민C"));

        ProductIngredient 코엔자임Q10 = productIngredientRepository.findByIngredientName("코엔자임Q10")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 코엔자임Q10"));

        ProductIngredient 오메가3 = productIngredientRepository.findByIngredientName("오메가-3")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 오메가-3"));

        ProductIngredient 루테인 = productIngredientRepository.findByIngredientName("루테인")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 루테인"));

        ProductIngredient 콜라겐 = productIngredientRepository.findByIngredientName("콜라겐")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 콜라겐"));

        ProductIngredient 인지질 = productIngredientRepository.findByIngredientName("인지질(PS)")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 인지질(PS)"));

        ProductIngredient 글루타민 = productIngredientRepository.findByIngredientName("글루타민")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 글루타민"));

        ProductIngredient 아연 = productIngredientRepository.findByIngredientName("아연")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 아연"));

        ProductIngredient 비오틴 = productIngredientRepository.findByIngredientName("비오틴")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 비오틴"));

        ProductIngredient 쏘팔메토 = productIngredientRepository.findByIngredientName("쏘팔메토")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 쏘팔메토"));

        ProductIngredient 아르기닌 = productIngredientRepository.findByIngredientName("아르기닌")
                .stream().findFirst()
                .orElseThrow(() -> new IllegalArgumentException("Ingredient not found: 아르기닌"));
