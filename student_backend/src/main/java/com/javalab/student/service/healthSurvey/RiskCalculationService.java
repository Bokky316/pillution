...
public class RiskCalculationService {
     ...
     */
    private String calculateCardiovascularRisk(int age, double bmi, List<MemberResponse> responses) {
        int riskScore = 0;

        // 나이와 BMI에 따른 기본 위험도 계산
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateDigestiveRisk(List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateSkinRisk(List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateEyeRisk(int age, List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateBrainRisk(int age, List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateFatigueRisk(List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateBoneJointRisk(int age, double bmi, List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateImmuneRisk(List<MemberResponse> responses) {
        int riskScore = 0;
     ...
     * @return 위험도 ("높음", "중간", "낮음" 중 하나)
     */
    private String calculateHairRisk(int age, List<MemberResponse> responses) {
        int riskScore = 0;
