...
const ProductDetailPage = () => {
  ...
  const handleOpenModal = () => setOpenModal(true);  // ✅ 모달 열기
  const handleCloseModal = () => setOpenModal(false); // ✅ 모달 닫기
        ...
        <Grid item xs={12}>
          ...
          <Box sx={{ display: "flex", alignItems: "center"}}>
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
              <Typography variant="body2" sx={{ minWidth: "60px", mt: "-40px",fontSize:15  }}>배송비</Typography>
            </Box>
